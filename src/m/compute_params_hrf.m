...
%
% Syntax: compute_params_HRF(INPUT_DIR, OUTPUT_DIR)
%
% INPUT_DIR: input dataset containing the original volume, HRF mat file and HRF parameters  (e.g. ADNI_23)
INPUT_DIR='../../../rsHRF_project/ADNI_23';
% subjects = dir([ INPUT_DIR '/*/*/rsfmri/Detrend_4DVolume.nii'])
%
% VUIISXNAT04_S17181/VUIISXNAT04_E231545
%
% 
%
...
for ii = 719:length(subjects)
    ii

    folder = [ subjects(ii).folder '/Deconv_Canonical_Detrend_4DVolume_'];
    f = [folder 'Time2dip.nii'];
    if isfile(f)
        disp("file exist")
    else
